...
import com.aite.a.activity.choiceActivity.ChoiceActivity;
...
public class HomeTabActivity extends TabActivity implements Mark {
    ...
    private void findViewById() {
        ...
        periphery = findViewById(R.id.home_tab_periphery);
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                        switch (checkedId) {
                            ...
                            case R.id.home_tab_periphery:// 周边商家
                                mTabHost.setCurrentTabByTag(TAB_PERIPHERY);
            ...
            switch (msg.what) {
                case 1:
                    ...
                    categoryBtn.setTextColor(getResources().getColor(
                            R.color.main_text));
                    periphery.setTextColor(getResources().getColor(
                            R.color.main_text));
                ...
                case 3:
                    ...
                    categoryBtn.setTextColor(getResources().getColor(
                            R.color.main_text));
                    periphery.setTextColor(getResources().getColor(R.color.red));
                    cartBtn.setTextColor(getResources().getColor(R.color.main_text));
                    personalBtn.setTextColor(getResources().getColor(
                            R.color.main_text));
