...
import com.aite.a.model.StoreInfoo.StoreCredit;
...
public class JsonParse {
    ...
    public static StoreInfoo getStoreDetils(String result) {
        ...
        try {
            ...
            String store_label = store_info.getString("store_label");
            ...
            storeInfo = new StoreInfoo(store_avatar, store_banner, store_id,
