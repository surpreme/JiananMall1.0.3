...
//                        img.delete();
     ...
     * @param price_to   价格结束
     */
    public void GoodsList(String key, String order, String page, String curpage, String gc_id, String store_id, String keyword
            , String b_id, String own_shop, String gift, String groupbuy, String xianshi, String virtual, String a_id, String price_from, String price_to) {
        params = new RequestParams();
        httpUtils = new HttpUtils();
        params.addQueryStringParameter("key", key);
        params.addQueryStringParameter("order", order);
     ...
     */
    public void DeliveryYuerDeposit(String pdc_amount, String pdc_bank_name, String pdc_bank_no, String pdc_bank_user, String pdc_alipay_account) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
     ...
     */
    public void DeliverySmsSend(String express_code, String code, String sms_code, String consignee_mobile) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
     ...
     */
    public void ExpressStorage(String express_id, String express_name, String express_code, String express_no, String consignee, String consignee_mobile,
     ...
     * @param sms_code         短信模板（发送短信是必选）
     */
    public void DeliveryOrderState(String order_id, String express_id, String express_name, String express_code, String express_no, String consignee,
                                   String consignee_mobile, String is_receivables, String is_send, String is_sendsms, String sms_code) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
        params.addBodyParameter("order_id", order_id);
     ...
     * @param inv_goto_addr
     */
    public void NewInvoice(String invoice_type, String inv_title, String inv_content, String inv_company
            , String inv_code, String inv_reg_addr, String inv_reg_phone, String inv_reg_bname, String inv_reg_baccount
            , String inv_rec_name, String inv_rec_mobphone, String area_info, String inv_goto_addr) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
     ...
     * @param password
     */
    public void VirtualConfirmOrderStep3(String goods_id, String quantity, String buyer_phone, String pd_pay, String password, String rcb_pay) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
        params.addBodyParameter("goods_id", goods_id);
     ...
     * 朋友圈首页
     */
    public void CircleoffriendsHome(String pagesize, String curpage, String circle_type, String keyword) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addQueryStringParameter("key", State.UserKey);
        params.addQueryStringParameter("pagesize", pagesize);
     ...
     * @param class_id
     */
    public void CircleoffriendsList(String class_id, String last_time, String keyword, String pagesize, String curpage) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addQueryStringParameter("key", State.UserKey);
        params.addQueryStringParameter("class_id", class_id);
     ...
     * @param thumb
     */
    public void CreateGettogether(String title, String class_id, String start_time, String end_time
     ...
     */
    public void CreateGroup(String circle_name, String c_desc, String c_tag, String c_pursuereason, String circle_back_img) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
     ...
     */
    public void ReleasePost(String article_title, String article_class, File article_image_upload, String article_content) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
     ...
     * @param theme_content
     */
    public void ReleaseCircleoffriends(String theme_content, List<File> data, String address, String privacy) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
     ...
     * @param cover
     */
    public void StartPush(String title, File cover, String room_class, String room_label, String area_info) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("key", State.UserKey);
        params.addBodyParameter("title", title);
...
//        params.addBodyParameter("pdr_amount", amount);
    ...
    public void onShoptypeChoice(RequestCallBack<String> call) {
        params = new RequestParams();
        httpUtils = new HttpUtils();
        params.addBodyParameter("key", Mark.State.UserKey);
//        params.addBodyParameter("pdr_amount", amount);
        httpUtils.send(HttpRequest.HttpMethod.POST, shop_type_choice, params,call
        );
    }
