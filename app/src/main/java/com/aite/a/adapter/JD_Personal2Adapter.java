...
import jd.page.JDClassifyActivity;
import jd.page.JDPersonalCenterActivity;
 ...
 *
 */
public class JD_Personal2Adapter extends Adapter<Personal2Holder> {
...
class Personal2Holder extends android.support.v7.widget.RecyclerView.ViewHolder {
	ImageView iv_img;
	TextView tv_name;
